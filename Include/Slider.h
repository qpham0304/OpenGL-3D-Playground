...
public:
	...
	string name;
	Slider();
	Slider(int x, int y, int size, float min, float max, float init, bool vertical = true, float textSize = 12, const char *name = NULL, vec3 *color = NULL);
	void Init(int x, int y, int size, float min, float max, float init, bool vertical = true, float textSize = 12, const char *name = NULL, vec3 *color = NULL);
